...
<div class="section">
  <h2>Can't Find an Exam in the Exambank?</h2>
  <p>The MathSoc Exambank is not the only Exambank on campus.  You can check the others to try to find the exam you\'re looking for:</p>
  <ul>
    <li><a href="http://www.scisoc.uwaterloo.ca/exambank/formex.html">Science Society Exambank</a></li>
